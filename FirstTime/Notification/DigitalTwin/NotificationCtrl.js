...
var vote_suffix = configuration.ballots_file;
...
var NotificationCtrl =
{
        ...
        writeNotification: function(req, res)
        {
                ...
                let suffix = notify_suffix;
                //if notification is coming from ballot.js we will change the file we write to
                if(params.propType) {suffix = vote_suffix;}
		...
		console.log("pubkey is: "+params.pubKey);
                ...
                var fileName = PATH + params.pubKey.toUpperCase() + suffix + ".json";
...
//CODE FOR 'expired notifications' ... 
