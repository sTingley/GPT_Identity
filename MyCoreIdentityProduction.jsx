...
class MyCoreIdentity extends React.Component
{
    constructor(props) {
        ...
        this.state = 
        {
            ...
            myContractAddress:"88B3FE647B76C998C77009CBFB6C3EF92B1977D1",
            ...
            <div id="MyCOIDContainer">
	    		...
	    		<form method="POST" id="MyCOID" role="form">
                    <div className="form-group">
						<label htmlFor="myControlAmount">Your current Control Token Amount is:  {this.state.requestResult.Result}</label>
					</div>
                </form>
                <div className="form-group">
