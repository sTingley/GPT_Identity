...
class DigitalIdentity extends React.Component {
	...
	render () {
	    return (
	    	<div id="DigitalIdentityContainer">
	    		<h2>Establish Identity</h2><hr/>
		    	<form method="POST" id="key-gen-form" role="form" onSubmit={this.keyGenerate}>
                        <div className="form-group">
                            <label htmlFor="files">Upload Core Identity Files</label>
                            <input type="file" name="files" multiple id="js-upload-files"/>
                            <span className="help-block">JSON(.json) & Image file formats only supported</span>
                        </div>
